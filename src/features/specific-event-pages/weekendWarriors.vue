<template>
  <div class="wrapper">
    <img src="" alt="" id="event-image" loading="lazy">
    <h1>Weekend Warriors 2020</h1>
    <p>A 2-day weekend training seminar on the Saturday the 18th and Sunday the 19th of April. Hosted at <a
         href="http://www.karateremuera.com/">Karate Remuera's</a> well equipped and generously sized dojo, this event
      promises to be a great one.
    <p>
      The idea is simple: to get you exposed to knowledge and experience that you wouldn't normally have access to
      during regular trainings.
    </p>
    <p>
      For this purpose we will be have a variety of instructors, click for more info.
    <ul>
      <li class="guest-instructor" @click="viewInstructor($event, 'sennen')">Sensei Harry Sennen, 5th Dan Goju Ryu</li>
      <li class="guest-instructor" @click="viewInstructor($event, 'murray')">Sensei Murray Simpson, 5th Dan Goju Ryu
      </li>
      <li class="guest-instructor" @click="viewInstructor($event, 'victor')">Victor Ng, owner of The Hawk's Nest</li>
      <li class="guest-instructor" @click="viewInstructor($event, 'tom')">Sensei Tom Davies, Fourth Dan Goju Ryu</li>
    </ul>
    </p>
    <button>Register Now!&nbsp;
    ...
    <p>The event location is <a href="https://g.page/karateremuera?share" target="_blank">6 Papahia Street, Parnell</a>
    </p>
