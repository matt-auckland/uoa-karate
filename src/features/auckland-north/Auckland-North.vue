  ...
  data: function () {
    return {
      ...
      richard: {
        ...
        danGrade: true,
        rank: 4,
        desc: `Sensei Richard has over ${Utils.calculateYears('03/01/2008')} years of Goju Ryu experience, and is the founder and head instructor of Auckland North.`,
